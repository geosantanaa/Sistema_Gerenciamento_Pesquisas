...
import br.com.start.service.ProfessorService;
...
public class ProfessorController {
	...
	@PostMapping
	public ProfessorSaidaDto criar(@Valid @RequestBody ProfessorEntradaDto entrada) {
	...
	@GetMapping("id/{id}")
	public ProfessorSaidaDto pegarUm(@PathVariable ("id") Long id) {
		log.info("PegarUm: {}", id);
